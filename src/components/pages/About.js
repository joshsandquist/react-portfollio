...
return (
    <div className='aboutPage'>
        ...
        <p>In 2018, I graduated from the University of Arizona with a degree in Public Policy and Administration. While the analytical and problem-solving skills I gained during my studies were valuable, my passion lay elsewhere - in the evolving world of web development. In pursuit of this passion, I recently completed the Full-Stack Web Development Bootcamp at the University of Arizona, reinforcing my technical knowledge and hands-on experience in both front end and back end development.</p>

        <p>My knack for code coupled with my background in public policy allows me to approach programming with a unique perspective. I believe that good coding isn't just about getting the job done—it's about creating user-friendly, efficient, and accessible digital environments that make a difference.</p>
